...
class WhoAmI(MycroftSkill):
    def __init__(self):
        ...
        self.df = pd.read_csv('/home/pi/.config/mycroft/skills/NewUserCreation/log.csv', names=['name', 'playlist', 'artist', 'artist2'])
    ...
    def handle_i_am_who(self, message):
        ...
        if confirm == "yes":
            ...
            new = self.get_response("sorry. WHo is this?")
            self.get_playlist(new)
